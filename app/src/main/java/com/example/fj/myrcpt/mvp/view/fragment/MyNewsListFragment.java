...
public class MyNewsListFragment extends Fragment implements SpringView.OnFreshListener {
    ...
    @SuppressLint("ValidFragment")
    public MyNewsListFragment(Context context, String category) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.new_list_fragment_item,container,false);
        initView(view);
        return view;
    }
    ...
    private static final String TAG = "MyNewsListFragment";
}
